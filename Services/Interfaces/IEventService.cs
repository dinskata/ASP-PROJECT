...
public interface IEventService
{
    ...
    Task<EventEditViewModel> BuildEditorAsync(int? id, IReadOnlyCollection<int>? allowedVenueIds = null);
    Task<int> CreateAsync(EventEditViewModel model, string? actorId = null, string? actorName = null, IReadOnlyCollection<int>? allowedVenueIds = null);
    Task<bool> UpdateAsync(EventEditViewModel model, string? actorId = null, string? actorName = null, IReadOnlyCollection<int>? allowedVenueIds = null);
